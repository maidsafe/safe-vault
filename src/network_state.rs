...
#[derive(Clone)]
pub struct NodeInfo {
    /// True if the node is the genesis, false otherwise
    pub genesis: bool,
    /// root directory where the node runs from
    pub root_dir: PathBuf,
    /// Where logs are stored for this node
    pub log_dir: PathBuf,
    /// Handle for the tracking of used space for the node
