...
impl SectionFunds {
    ...
    pub async fn transition(&mut self, to: TransferActor<Validator>) -> Option<MessagingDuty> {
    ...
    pub async fn initiate_reward_payout(&mut self, payout: Payout) -> Option<MessagingDuty> {
