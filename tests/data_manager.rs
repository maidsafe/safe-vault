...
#[test]
fn handle_put_get_normal_flow_without_churn() {
    let network = Network::new();
    let node_count = 15;
    let mut nodes = test_node::create_nodes(&network, node_count, None);
    let config = mock_crust::Config::with_contacts(&[nodes[0].endpoint()]);
...
#[test]
fn handle_put_get_error_flow_without_churn() {
    let network = Network::new();
    let node_count = 15;
    let mut nodes = test_node::create_nodes(&network, node_count, None);
    let config = mock_crust::Config::with_contacts(&[nodes[0].endpoint()]);
...
#[test]
fn handle_post_error_flow_without_churn() {
    let network = Network::new();
    let node_count = 15;
    let mut nodes = test_node::create_nodes(&network, node_count, None);
    let config = mock_crust::Config::with_contacts(&[nodes[0].endpoint()]);
...
#[test]
fn handle_delete_error_flow_without_churn() {
    let network = Network::new();
    let node_count = 15;
    let mut nodes = test_node::create_nodes(&network, node_count, None);
    let config = mock_crust::Config::with_contacts(&[nodes[0].endpoint()]);
